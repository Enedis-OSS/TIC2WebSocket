...
public class TIC2WebSocketCommandLine
{
	...
	@Option(names = { "--version" }, versionHelp = true, description = "Display version")
	boolean	versionRequested	= false;

	//@formatter:off
	@Option(names = { "-v",
			"--verbose" }, defaultValue = "2", paramLabel = "LEVEL",
			description = "Define verbosity level:\n" + 
								"0 ou OFF = muted\n" + 
	...
	@Option(names = { "--configFile" }, paramLabel = "PATH", description = "Set configuration file")
