...
public interface TICCore extends Task
{
	 ...
	 *             if identifier not found or if any error occurs
	 */
	 ...
	 *
	 * @param identifier
	 *            the identifier used for subscription
	 * @param listener
	 *            the subscriber reference
	 * @throws Exception
	 *             on subscription failure
	 */
	public void subscribe(TICIdentifier identifier, TICCoreSubscriber listener) throws TICCoreException;
	 ...
	 *            the subscriber reference
	 * @throws Exception
	 *             if filter or listener not found
	 */
	public void unsubscribe(TICIdentifier identifier, TICCoreSubscriber listener) throws TICCoreException;
