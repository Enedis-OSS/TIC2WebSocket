...
public class TICCoreError extends DataDictionaryBase
{
	 ...
	 * @throws DataDictionaryException
	 */
	public TICCoreError(TICIdentifier identifier, Number errorCode, String errorMessage) throws DataDictionaryException
	{
	 ...
	 * @throws DataDictionaryException
	 */
	public TICCoreError(TICIdentifier identifier, Number errorCode, String errorMessage, DataDictionary data) throws DataDictionaryException
	{
		this();
