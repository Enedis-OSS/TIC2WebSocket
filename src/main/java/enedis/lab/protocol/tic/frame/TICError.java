...
public enum TICError
{
	...
	public static TICError getSerialPortError(SerialPortException serialPortException)
	{
		...
		if (serialPortException.getExceptionType().equals(SerialPortException.TYPE_INCORRECT_SERIAL_PORT))
		{
			return TICError.SERIAL_PORT_INCORRECT_SERIAL_PORT;
		}
		if (serialPortException.getExceptionType().equals(SerialPortException.TYPE_NULL_NOT_PERMITTED))
		{
		...
		if (serialPortException.getExceptionType().equals(SerialPortException.TYPE_PORT_ALREADY_OPENED))
		{
