...
public class TICStreamConfiguration extends DataStreamConfiguration
{
	...
	private static final DataStreamDirection[]	DIRECTION_ACCEPTED_VALUES	= { DataStreamDirection.OUTPUT, DataStreamDirection.INPUT };
	 ...
	 * @throws DataDictionaryException
	 */
	public TICStreamConfiguration(String name, DataStreamDirection direction, String channelName, TICMode ticMode) throws DataDictionaryException
	{
		this();
