...
public class ConfigurationException extends DataDictionaryException
{
	 ...
	 * @return configurationException
	 */
	public static ConfigurationException createInvalidParameterValueException(String parameter, String info)
	{
		return new ConfigurationException("Parameter \'" + parameter + "\' has an invalid value : " + info);
	}
	 ...
	 * @return configurationException
	 */
	public static ConfigurationException createInvalidParameterTypeException(String parameter, Class<?> type)
	{
		return new ConfigurationException("Parameter \'" + parameter + "\' has an invalid type : " + type.getName());
	}
