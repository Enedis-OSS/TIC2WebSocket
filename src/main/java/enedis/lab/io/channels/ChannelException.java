 ...
 *
 * <p>This exception is thrown when errors occur during channel operations such as setup,
 * configuration, read/write operations, or channel management. It extends {@link ExceptionBase} to
 * provide structured error handling with error codes and detailed error messages.
 *
 * <p>The class provides static factory methods for creating specific types of channel exceptions,
 * each with appropriate error codes and descriptive messages.
 *
 * <p>Common scenarios that trigger this exception include:
 *
 * <ul>
 *   <li>Invalid channel configuration
 *   <li>Channel not ready for operations
 *   <li>Conflicting channel types
 *   <li>Operation denied due to channel state
 *   <li>Internal channel errors
 * </ul>
 *
...
public class ChannelException extends ExceptionBase {
   ...
   *
   * <p>This method is used when an attempt is made to create or use a channel type that is not
   * supported by the system.
   *
   * @param channelType the unsupported channel type that was requested
   * @throws ChannelException always thrown with error code {@link #ERRCODE_INVALID_CHANNEL}
   */
   ...
   *
   * <p>This method is used when a channel type conflicts with an expected type, typically during
   ...
   *
   * <p>This method is used when an internal error occurs during channel processing that cannot be
   * attributed to user input or configuration.
   *
   * @param info additional information about the internal error
   * @throws ChannelException always thrown with error code {@link #ERRCODE_INTERNAL_ERROR}
   */
   ...
   *
   * <p>This method is used when an operation is attempted on a channel that is not in a ready state
   * (e.g., not properly configured or initialized).
   *
   * @param info additional information about why the channel is not ready
   * @throws ChannelException always thrown with error code {@link #ERRCODE_CHANNEL_NOT_READY}
   */
   ...
   *
   * <p>This method is used when a channel configuration is of the wrong type for the expected
   * channel implementation.
   *
   * @param configuration the invalid configuration that was provided
   * @param expected_configuration_name the name of the expected configuration type
   * @throws ChannelException always thrown with error code {@link
   ...
   *
   * <p>This method is used when channel configuration parameters are invalid, missing, or
   * incompatible.
   *
   * @param info additional information about the configuration error
   * @throws ChannelException always thrown with error code {@link #ERRCODE_INVALID_CONFIGURATION}
   */
   ...
   *
   * <p>This method is used when an operation is attempted that is not allowed in the current
   * channel state or configuration.
   *
   * @param operation the operation that was denied
   * @throws ChannelException always thrown with error code {@link #ERRCODE_OPERATION_DENIED}
   */
   ...
   *
   * <p>This method is used when an unexpected or unhandled error occurs during channel operations.
   *
   * @param info additional information about the unexpected error
   * @throws ChannelException always thrown with error code {@link #ERRCODE_UNEXPECTED}
   */
   ...
   *
   * <p>This method is used when attempting to create a channel with a name that already exists in
   * the system.
   *
   * @param channelName the name of the channel that already exists
   * @throws ChannelException always thrown with error code {@link #ERRCODE_ALREADY_EXISTS}
   */
   ...
   *
   * <p>This method is used when attempting to perform operations on a channel that does not exist
   * in the system.
   *
   * @param channelName the name of the channel that does not exist
   * @throws ChannelException always thrown with error code {@link #ERRCODE_CHANNEL_DOESNT_EXIST}
   */
   ...
   *
   * <p>This constructor creates a channel exception with a specific error code and descriptive
   * message. The error code should be one of the predefined constants in this class.
   *
