 ...
 * <p>
 * This interface extends {@link Subscriber} and provides methods for handling
 * various channel events such as data read/write operations, status changes,
 * and error conditions. Implementations of this interface can be registered
 * with channels to receive real-time notifications about channel activities.
 * <p>
 * The listener pattern allows for decoupled event handling, enabling multiple
 * listeners to be registered with a single channel and receive notifications
 * about all channel activities.
 * <p>
 * Common use cases include:
 * <ul>
 * <li>Logging channel activities</li>
 * <li>Monitoring channel status</li>
 * <li>Processing received data</li>
...
public interface ChannelListener extends Subscriber {
   ...
   * operation.
   * The received data is provided as a byte array containing the raw data
   ...
   * <p>
   * This method is invoked whenever a channel performs a successful write
   * operation.
   * The transmitted data is provided as a byte array containing the raw data
   * that was written to the channel.
   *
   ...
   * <p>
   * This method is invoked whenever a channel's operational status changes,
   * such as when it goes from closed to open, or from ready to error state.
   * This allows listeners to monitor channel state transitions.
   *
   ...
   * <p>
   * This method is invoked whenever an error occurs during channel operations.
   * It provides basic error information including the error code and message.
   *
   ...
   * <p>
   * This method is invoked whenever an error occurs during channel operations
   * and additional context data is available. It provides comprehensive error
   * information including the error code, message, and associated data
   * dictionary.
   *
   * @param channelName  the name of the channel where the error occurred
   * @param errorCode    the numeric error code identifying the type of error
