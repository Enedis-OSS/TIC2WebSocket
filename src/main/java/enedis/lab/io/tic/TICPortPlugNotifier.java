...
public class TICPortPlugNotifier extends PortPlugNotifier<TICPortFinder,TICPortDescriptor>
{
	...
	public static void main(String[] args)
	{
		...
		PlugSubscriber<TICPortDescriptor> subscriber = new PlugSubscriber<TICPortDescriptor>()
		{
			@Override
			...
			{
				JSONObject jsonObject = new JSONObject();
				jsonObject.put(notifier.getClass().getSimpleName() + ".onUnplugged", descriptor.toJSON());
				System.out.println(jsonObject.toString(DEFAULT_JSON_INDENTATION) + "\n");
			}
		};
