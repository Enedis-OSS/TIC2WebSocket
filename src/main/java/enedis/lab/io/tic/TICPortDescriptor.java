...
public class TICPortDescriptor extends SerialPortDescriptor
{
	 ...
	 * @throws DataDictionaryException
	 */
	public TICPortDescriptor(String portId, String portName, String description, String productName, String manufacturer, String serialNumber, TICModemType modemType)
			throws DataDictionaryException
	{
		this();
	 ...
	 * @throws DataDictionaryException
	 */
	public TICPortDescriptor(SerialPortDescriptor serialPortDescriptor, TICModemType modemType) throws DataDictionaryException
	{
		this();
	 ...
	 * @throws DataDictionaryException
	 */
	public TICPortDescriptor(USBPortDescriptor usbPortDescriptor, TICModemType modemType) throws DataDictionaryException
	{
		this();
	...
	private void checkProductId(Number productId, TICModemType modemType) throws DataDictionaryException
	{
		if (modemType != null && productId != null && productId.intValue() != modemType.getProductId())
		{
			throw new DataDictionaryException("TIC modem productId is inconsistent with the given one");
		}
	}

	private void checkVendorId(Number vendorId, TICModemType modemType) throws DataDictionaryException
	{
	...
	private void loadKeyDescriptors()
	{
		try
		{
			this.kModemType = new KeyDescriptorEnum<TICModemType>(KEY_MODEM_TYPE, false, TICModemType.class);
