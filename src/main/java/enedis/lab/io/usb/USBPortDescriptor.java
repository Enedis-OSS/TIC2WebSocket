...
public class USBPortDescriptor extends DataDictionaryBase
{
	 ...
	 * @throws DataDictionaryException
	 */
	public USBPortDescriptor(Number bcdDevice, Number bcdUSB, Number bDescriptorType, Number bDeviceClass, Number bDeviceProtocol, Number bDeviceSubClass, Number bLength,
			Number bMaxPacketSize0, Number bNumConfigurations, Number idProduct, Number idVendor, Number iManufacturer, Number iProduct, Number iSerialNumber, String manufacturer,
			String product, String serialNumber) throws DataDictionaryException
	{
		this();
