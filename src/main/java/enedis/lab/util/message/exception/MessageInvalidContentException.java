 ...
 *
 * <p>This exception is thrown when the content of a message does not conform to the expected structure,
 * contains invalid values, or fails validation during parsing or processing. It is part of the message
 * exception hierarchy used to signal specific errors in communication.
 *
 * <p>Common use cases include:
 * <ul>
 *   <li>Detecting missing or malformed fields in a message</li>
 *   <li>Reporting invalid data values or types</li>
 *   <li>Handling content validation failures</li>
