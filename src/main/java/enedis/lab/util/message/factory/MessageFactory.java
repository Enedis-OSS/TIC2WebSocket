...
public class MessageFactory
{
	 ...
	 * @param eventFactory
	 */
	public MessageFactory(RequestFactory requestFactory, ResponseFactory responseFactory, EventFactory eventFactory)
	{
		super();
	 ...
	 */
	public Message getMessage(String text) throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		...
		{
			case REQUEST:	message = this.requestFactory.getMessage(text, genericMessage.getName()); 		break;
			case RESPONSE:	message = this.responseFactory.getMessage(text, genericMessage.getName()); 	break;
			case EVENT:		message = this.eventFactory.getMessage(text, genericMessage.getName()); 			break;
			default:
				break;
		}
		// @formatter:on
	...
	private void checkSubFactoryReferences()
	{
		...
		{
			throw new IllegalStateException("requestFactory, responseFactory and eventFactory have to be set");
		}
	}
