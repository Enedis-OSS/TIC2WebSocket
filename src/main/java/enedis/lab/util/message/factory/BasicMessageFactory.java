...
public abstract class BasicMessageFactory
{
	...
	public static Message getMessage(String text)
			throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException, MessageInvalidTypeException
	{
	...
	private static JSONObject convertTextToJson(String text) throws MessageInvalidFormatException
	{
		...
		{
			throw new MessageInvalidFormatException("Invalid format, it should be JSON : " + e.getMessage());
		}
	}

	private static MessageType extractType(JSONObject jsonObj) throws MessageKeyTypeDoesntExistException, MessageInvalidFormatException, MessageInvalidTypeException
	{
		try
		{
	...
	private static void checkKeyTypeExists(JSONObject jsonObj) throws MessageKeyTypeDoesntExistException
	{
	...
	private static String extractName(JSONObject jsonObj) throws MessageInvalidFormatException, MessageKeyNameDoesntExistException
	{
		try
		{
	...
	private static void checkKeyNameExists(JSONObject jsonObj) throws MessageKeyNameDoesntExistException
	{
