 ...
 *
 * <p>This exception is thrown when a message specifies a type that is not recognized, not
 * supported, or does not match the expected types during parsing or processing. It is part of the
 * message exception hierarchy used to signal specific errors in communication.
 *
 * <p>Common use cases include:
 *
 * <ul>
 *   <li>Detecting unknown or unsupported message types
 *   <li>Reporting type mismatches in message definitions
 *   <li>Handling validation failures due to type errors
