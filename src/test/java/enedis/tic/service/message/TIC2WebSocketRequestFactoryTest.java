...
{
	@Test
	public void testGetMessage_RequestGetAvailableTics() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		...
		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestGetAvailableTICs.NAME + "\"}";
	...
	@Test
	public void testGetMessage_RequestGetModemsInfo() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestGetModemsInfo.NAME + "\"}";
	...
	@Test
	public void testGetMessage_RequestReadTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestReadTIC.NAME + "\",\"data\":{\"serialNumber\":\"010203040506\"}}";
	...
	@Test
	public void testGetMessage_RequestSubscribeTIC_allTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestSubscribeTIC.NAME + "\"}";
	...
	@Test
	public void testGetMessage_RequestSubscribeTIC_oneTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestSubscribeTIC.NAME + "\",\"data\":{\"serialNumber\":\"010203040506\"}}";
	...
	@Test
	public void testGetMessage_RequestSubscribeTIC_severalTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();
	...
	@Test
	public void testGetMessage_RequestUnsubscribeTIC_allTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestUnsubscribeTIC.NAME + "\"}";
	...
	@Test
	public void testGetMessage_RequestUnsubscribeTIC_oneTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();

		String text = "{\"type\":\"" + MessageType.REQUEST.name() + "\",\"name\":\"" + RequestUnsubscribeTIC.NAME + "\",\"data\":{\"serialNumber\":\"010203040506\"}}";
	...
	@Test
	public void testGetMessage_RequestUnsubscribeTIC_severalTIC() throws MessageInvalidFormatException, MessageKeyTypeDoesntExistException, MessageKeyNameDoesntExistException,
			MessageInvalidTypeException, UnsupportedMessageException, MessageInvalidContentException
	{
		TIC2WebSocketRequestFactory factory = new TIC2WebSocketRequestFactory();
