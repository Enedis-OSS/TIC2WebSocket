...
public class TIC2WebSocketResponseFactoryTest {
  @Test
  public void testGetMessage_ResponseGetAvailableTics()
  ...
  @Test
  public void testGetMessage_ResponseGetModemsInfo()
      throws MessageInvalidFormatException,
          MessageKeyTypeDoesntExistException,
          MessageKeyNameDoesntExistException,
          MessageInvalidTypeException,
  ...
  @Test
  public void testGetMessage_ResponseReadTIC()
      throws MessageInvalidFormatException,
          MessageKeyTypeDoesntExistException,
          MessageKeyNameDoesntExistException,
          MessageInvalidTypeException,
  ...
  @Test
  public void testGetMessage_ResponseSubscribeTIC()
      throws MessageInvalidFormatException,
          MessageKeyTypeDoesntExistException,
          MessageKeyNameDoesntExistException,
          MessageInvalidTypeException,
    ...
    String text =
        "{\"type\":\""
            + MessageType.RESPONSE.name()
            + "\",\"name\":\""
            + ResponseSubscribeTIC.NAME
            + "\",\"dateTime\":\"01/01/2000 00:00:00\",\"errorCode\":0}";
  ...
  @Test
  public void testGetMessage_ResponseUnsubscribeTIC_allTIC()
      throws MessageInvalidFormatException,
          MessageKeyTypeDoesntExistException,
          MessageKeyNameDoesntExistException,
          MessageInvalidTypeException,
