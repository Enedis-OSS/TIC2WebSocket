...
public class TIC2WebSocketServerTest
{
    ...
    public void testServerInstantiation()
    {
        ...
        TIC2WebSocketRequestHandler requestHandler = new TIC2WebSocketRequestHandlerBase(
                new TICCoreBase(TICMode.HISTORIC, Arrays.asList("COM1")));

        // Test server creation
        TIC2WebSocketServer server = new TIC2WebSocketServer("localhost", 8080, clientPool, requestHandler);
