...
public class TICCoreBaseTest
{
	...
	public void startTICCore() throws TICCoreException
	{
		...
		this.ticCore = new TICCoreBase(this.ticPortFinder, this.plugNotifierPeriod, TICCoreStreamMock.class, TICMode.AUTO, null);
	...
	public void test_getAvailableTICs() throws TICCoreException, DataDictionaryException
	{
		...
		TICPortDescriptor descriptor1 = new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD);
		TICPortDescriptor descriptor2 = new TICPortDescriptor("2", "COM4", null, null, null, null, TICModemType.TELEINFO);
	...
	public void test_getModemsInfo() throws TICCoreException, DataDictionaryException
	{
		...
		TICPortDescriptor descriptor1 = new TICPortDescriptor(null, "COM3", null, null, null, null, TICModemType.MICHAUD);
		TICPortDescriptor descriptor2 = new TICPortDescriptor(null, "COM4", null, null, null, null, TICModemType.TELEINFO);
		this.plugModem(descriptor1);
		this.plugModem(descriptor2);
	...
	{
		TICIdentifier identifier = this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
		...
		TICCoreFrame frame = this.createFrame(identifier, TICMode.STANDARD, LocalDateTime.of(2020, 3, 3, 12, 59, 30, 0));
	...
	@Test
	public void test_readNextFrame_error_OTHER_REASON() throws TICCoreException, DataDictionaryException
	{
		TICIdentifier identifier = this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
		Assert.assertEquals(1, TICCoreStreamMock.streams.size());
		TICCoreStreamMock stream = TICCoreStreamMock.streams.get(0);
		...
		this.waitTaskRunning(task);
		this.waitReadNextFrameSubsbription();
		TICCoreError error = new TICCoreError(identifier, TICCoreErrorCode.OTHER_REASON.getCode(), "Cannot read stream");
	...
	@Test
	public void test_readNextFrame_error_STREAM_IDENTIFIER_NOT_FOUND() throws TICCoreException, DataDictionaryException
	{
		TICIdentifier identifier = this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
		Assert.assertEquals(1, TICCoreStreamMock.streams.size());
		TICCoreStreamMock stream = TICCoreStreamMock.streams.get(0);
		...
		TICCoreReadNextFrameTask task = new TICCoreReadNextFrameTask(this.ticCore, new TICIdentifier("2", "COM3", null));
		task.start();
		this.waitTaskRunning(task);
		this.waitTaskTerminated(task);
		Assert.assertNull(task.frame);
		...
		Assert.assertTrue(task.exception instanceof TICCoreException);
		TICCoreException exception = (TICCoreException) task.exception;
		Assert.assertEquals(TICCoreErrorCode.STREAM_IDENTIFIER_NOT_FOUND.getCode(), exception.getErrorCode());
	}
	...
	@Test
	public void test_unsubscribe_withIdentifier_ok() throws TICCoreException, DataDictionaryException
	{
		TICIdentifier identifier = this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
	...
	@Test
	public void test_subscribe_withIdentifier_notFound() throws TICCoreException, DataDictionaryException
	{
		this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
		...
		{
			this.ticCore.subscribe(identifier, subscriber);
			Assert.fail("Subscribe should have trhown an exception since stream identifier does not match !");
		}
		catch (Exception e)
		{
	...
	public void test_onError_whenUnplugModem() throws TICCoreException, DataDictionaryException
	{
		...
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber1.onErrorCalls.get(0).error.getErrorCode());
		this.waitSubscriberNotification(subscriber2.onErrorCalls, 1);
		Assert.assertEquals(1, subscriber2.onErrorCalls.size());
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber2.onErrorCalls.get(0).error.getErrorCode());
		this.waitSubscriberNotification(subscriber3.onErrorCalls, 1);
		Assert.assertEquals(1, subscriber3.onErrorCalls.size());
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber3.onErrorCalls.get(0).error.getErrorCode());
		...
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber4.onErrorCalls.get(0).error.getErrorCode());
		this.waitSubscriberNotification(subscriber5.onErrorCalls, 1);
		Assert.assertEquals(1, subscriber5.onErrorCalls.size());
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber5.onErrorCalls.get(0).error.getErrorCode());
		this.waitSubscriberNotification(subscriber1.onErrorCalls, 1);
		Assert.assertEquals(2, subscriber1.onErrorCalls.size());
		Assert.assertEquals(TICCoreErrorCode.STREAM_UNPLUGGED.getCode(), subscriber1.onErrorCalls.get(1).error.getErrorCode());
		Assert.assertEquals(1, subscriber2.onErrorCalls.size());
		Assert.assertEquals(1, subscriber3.onErrorCalls.size());
	}
	...
	public void test_onData_any() throws TICCoreException, DataDictionaryException
	{
		...
		TICCoreFrame frame1 = this.createFrame(stream1.getIdentifier(), TICMode.STANDARD, LocalDateTime.of(2020, 3, 3, 12, 59, 30, 0));
		...
		this.plugModem(new TICPortDescriptor("2", "COM4", null, null, null, null, TICModemType.TELEINFO));
		TICCoreStreamMock stream2 = TICCoreStreamMock.streams.get(1);
		TICCoreFrame frame2 = this.createFrame(stream2.getIdentifier(), TICMode.HISTORIC, LocalDateTime.of(2017, 2, 14, 9, 37, 12, 0));
	...
	public void test_onData_withIdentifier() throws TICCoreException, DataDictionaryException
	{
		...
		this.plugModem(new TICPortDescriptor("2", "COM4", null, null, null, null, TICModemType.MICHAUD));
		TICCoreStreamMock stream2 = TICCoreStreamMock.streams.get(1);
		TICCoreFrame frame2 = this.createFrame(stream2.getIdentifier(), TICMode.HISTORIC, LocalDateTime.of(2017, 2, 14, 9, 37, 12, 0));
		stream2.notifyOnData(frame2);
		this.waitSubscriberNotification(subscriber.onDataCalls, 1);
	...
	public void test_onError_any() throws TICCoreException, DataDictionaryException
	{
		...
		Assert.assertEquals(1, TICCoreStreamMock.streams.size());
		TICCoreStreamMock stream1 = TICCoreStreamMock.streams.get(0);
		TICCoreError error1 = new TICCoreError(stream1.getIdentifier(), TICCoreErrorCode.OTHER_REASON.getCode(), "Cannot read stream");
		...
		this.plugModem(new TICPortDescriptor("2", "COM4", null, null, null, null, TICModemType.TELEINFO));
		TICCoreStreamMock stream2 = TICCoreStreamMock.streams.get(1);
		TICCoreError error2 = new TICCoreError(stream2.getIdentifier(), TICCoreErrorCode.OTHER_REASON.getCode(), "Error reading stream COM4");
	...
	{
		TICIdentifier identifier1 = this.plugModem(new TICPortDescriptor("1", "COM3", null, null, null, null, TICModemType.MICHAUD));
		TICIdentifier identifier2 = this.plugModem(new TICPortDescriptor("2", "COM4", null, null, null, null, TICModemType.TELEINFO));
	...
	private TICCoreFrame createFrame(TICIdentifier identifier, TICMode mode, LocalDateTime localDateTime) throws DataDictionaryException
	{
